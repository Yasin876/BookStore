                               ...
                               @foreach(Cart::content() as $cartItem)
                                   <tr class="cart_item">
                                       ...
                                       <td class="product-remove">
                                               ...
                                               <a href="{{route('cart.delete',$cartItem->rowId)}}" class="product-del remove" title="Remove this item">
                                       ...
                                       <td class="product-thumbnail">
                                           ...
                                           <div class="cart-product__item">
                                               <a href="#">
                                                   <img src="{{$cartItem->model->image}}" alt="product" class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image">
                                               </a>
                                               <div class="cart-product-content">
                                                   <p class="cart-author">Kristin Hannah</p>
                                       ...
                                       <td class="product-quantity">
                                           ...
                                           <div class="quantity">
                                               <a href="{{route('cart.decr',['id'=>$cartItem->rowId ,'qty'=>$cartItem->qty])}}" class="quantity-minus">-</a>
                                               <input title="Qty" class="email input-text qty text" type="text" placeholder="1" readonly value="{{$cartItem->qty}}">
                                               <a href="{{route('cart.incr',['id'=>$cartItem->rowId ,'qty'=>$cartItem->qty])}}" class="quantity-plus">+</a>
                                           </div>

                                       </td>

                                       <td class="product-subtotal">
                                           <h5 class="total amount">${{$cartItem->total()}}</h5>
                                       </td>
