            ...
            <div class="books-grid">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                            <div class="books-item">
                                ...
                                <div class="books-item-info">
                                    <h5 class="books-title"><a href="{{route('product.single',$product->id)}}">{{$product->name}}</a> </h5>

                                    <div class="books-price">{{$product->price}} $</div>
                                </div>

                                    {{-- add to cart as rapid --}}
                ...
                <div class="row pb120">
                   ...
                   <div class="col-lg-12">
                       ...
                       {{$products->links('pagination::default')}} {{-- we used laravel default paginate --}}
